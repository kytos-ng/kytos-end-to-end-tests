...
class TestE2EMefEline:
    ...
    def test_001_not_ownership(self):
        ...
        evc_id = self.create_evc(
            ...
            uni_z="00:00:00:00:00:00:00:03:1",
            vlan_id=100,
            primary_constraints={"mandatory_metrics": {"not_ownership": ["red"]}},
            secondary_constraints={
                "spf_attribute": "hop",
                "mandatory_metrics": {"not_ownership": ["blue"]}
            },
        )
        ...
        assert data["primary_constraints"] == {
            "mandatory_metrics": {"not_ownership": ["red"]}
        }
        ...
        assert not (current_path_ids & red_link_ids), current_path_ids
        assert not (failover_path_ids & blue_link_ids), failover_path_ids
